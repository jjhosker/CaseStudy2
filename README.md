...
# Introduction
### This repository for this case study accomplishes data cleaning, graphing, and analysis. Most of the analysis was conducted in R Studio, with the remainder in Python (version 3.6.0) and SAS Studio (version 3.4). This analysis was performed using R version 3.3.2. The purpose of this case study is to complete several analyses that touch on all aread covered in the course "Doing Data Science."   
...
###   4. RFunctions_CaseStudy2.R:  This file can be found in the Analysis sub-directory under the CaseStudy2 GitHub repository.   This file contains the functions that are loaded and uses the main R makefile(RMakefile_CaseStudy2.R).
